...
1. **Knife with Buttons:**
   ...
   - Enables unique actions triggered by doing a chopping motion with the knife.
     <img src="https://github.com/eske4/P5-OvercookedController/blob/main/images/knife.gif" width="500">
...
2. **Plate Controller:**
   ...
   - Utilizes an accelerometer to track the tilt of the plate, adding an immersive dimension to the gameplay.
     <img src="https://github.com/eske4/P5-OvercookedController/blob/main/images/plate.gif" width="500">
...
3. **Receiver:**
   ...
   - Enables Bluetooth communication between the controller components and the gaming system.
     <img src="https://github.com/eske4/P5-OvercookedController/blob/main/images/Sugar.jpg" width="500">

## <p align="center">Controllers showcase:</p>
Below the interaction with the controllers and their hardware can be seen
<div align="center">
<img src="https://github.com/eske4/P5-OvercookedController/blob/main/images/Info.jpg" width="500">
</div>
